...
class SearchAdapter(var context: Context, var userList: ArrayList<com.example.instagramclone.Models.User>):RecyclerView.Adapter<SearchAdapter. ViewHolder> () {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        var isfollow=false
        Glide.with (context).load(userList.get(position).image).placeholder (R.drawable.userimage). into (holder .binding.profileImage)
